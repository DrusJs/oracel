...
export default function AccountPage() {
    ...
    return (
        <main className="main flex flex-col flex-1">
                    ...
                    <div className="flex flex-col w-full md:px-0 px-4">
                        <div className="bg-gray-secondary rounded-3xl md:p-11 py-8 px-6 flex flex-col gap-10">
                            ...
                            <div className="flex flex-wrap gap-10">
                                ...
                                <button className="bg-green rounded-full font-bold text-xl md:px-12 md:py-5 px-4 py-4 flex justify-center gap-4 items-center text-nowrap hover:opacity-80">
                                    Get your bonus
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.29289 0.292893C7.68342 -0.0976311 8.31658 -0.0976311 8.70711 0.292893L15.7071 7.29289C16.0976 7.68342 16.0976 8.31658 15.7071 8.70711L8.70711 15.7071C8.31658 16.0976 7.68342 16.0976 7.29289 15.7071C6.90237 15.3166 6.90237 14.6834 7.29289 14.2929L12.5858 9H1C0.447715 9 0 8.55229 0 8C0 7.44772 0.447715 7 1 7H12.5858L7.29289 1.70711C6.90237 1.31658 6.90237 0.683417 7.29289 0.292893Z" fill="#1C1B23"/>
                                    </svg>
            ...
            <div className="xl:container max-w-full pt-20 lg:px-8 pl-4 flex lg:flex-col flex-row lg:gap-4">
                <div className="lg:flex grid grid-cols-1 rounded-2xl bg-green min-w-20 lg:mb-0 mb-5">
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/6">Date</div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/12">Order </div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/12">Amount</div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/4">Forecast</div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/6">Winner</div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/12">Score</div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/12">Handicap</div>
                    <div className="lg:text-xl text-sm font-bold font-body py-4 justify-center flex items-center lg:basis-1/6">Total</div>
                </div>
                <div className="account-table flex lg:flex-col flex-row overflow-auto lg:max-h-96 lg:mt-10 rounded-2xl gap-4 pr-8">
                    <div className="lg:flex grid grid-cols-1 gap-2 font-bold font-body text-center text-white min-w-56">
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/6">27.01.2024</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/12">095434</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/12">1</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/4">NaVi VS Team Spirit</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/6">Team Spirit</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/12">0-2</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/12">2.20</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/6">5.00</div>
                    </div>
                    <div className="lg:flex grid grid-cols-1 gap-2 font-bold font-body text-center text-white min-w-56">
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/6">27.01.2024</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 px-1 flex items-center justify-center basis-1/12">095434</div>
