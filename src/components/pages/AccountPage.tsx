            ...
            <div className="xl:container max-w-full pt-20 lg:px-8 pl-4 flex lg:flex-col flex-row lg:gap-4">
                ...
                <div className="account-table flex lg:flex-col flex-row overflow-auto lg:max-h-96 lg:mt-10 rounded-2xl gap-4 pr-8">
                    <div className="lg:flex grid grid-cols-1 gap-2 font-bold font-body text-center text-white min-w-56">
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/6">27.01.2024</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/12">1</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/4">NaVi VS Team Spirit</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/6">Team Spirit</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/12">0-2</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/12">2.20</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/6">5.00</div>
                    </div>
                    <div className="lg:flex grid grid-cols-1 gap-2 font-bold font-body text-center text-white min-w-56">
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/6">27.01.2024</div>
                        <div className="lg:text-2xl text-base rounded-2xl bg-gray-secondary py-4 basis-1/12">1</div>
