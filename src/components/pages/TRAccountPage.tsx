export default function TRAccountPage() {
        ...
        <main className="main flex flex-col flex-1">
            <div className="container container-sm md:px-8 px-0 pt-20">
                <div className="flex flex-wrap gap-10 items-center justify-between md:px-0 px-4">
                    <h1 className="font-body md:text-5xl text-4xl text-white uppercase font-semibold">Kişisel hesap</h1>
                ...
                <div className="flex mt-10 gap-10 items-start flex-wrap lg:flex-nowrap">
                    <div className="bg-green rounded-3xl md:p-12 py-8 px-6 flex flex-col w-full max-w-[480px] md:min-w-[460px]">
                        <p className="text-2xl uppercase font-body font-semibold md:mb-10 mb-6">Yönlendirme programı</p>
                        <p className="font-display text-xl mb-3">Kodunuz</p>
                        ...
                        <p className="flex items-center font-body text-xl gap-4 font-semibold">
                            ...
                            Refferal program Şartları ve Politikası
                        </p>
                    </div>
                    <div className="flex flex-col w-full md:px-0 px-4">
                        <div className="bg-gray-secondary rounded-3xl md:p-11 py-8 px-6 flex flex-col gap-10">
                            <p className="text-3xl text-white font-bodt font-semibold uppercase">10 Eur'nuzu almak için bir tavsiye kodu girin</p>
                            <div className="flex flex-wrap gap-10">
                                <div className="flex gap-2 md:pl-0 pl-3">
                                    <input className="bg-transparent text-white text-center text-4xl font-body md:w-10 w-8 border-b-4 border-white" type="text" max-length="1" />
                                    <input className="bg-transparent text-white text-center text-4xl font-body md:w-10 w-8 border-b-4 border-white" type="text" max-length="1" />
                                    <input className="bg-transparent text-white text-center text-4xl font-body md:w-10 w-8 border-b-4 border-white" type="text" max-length="1" />

                                    <input className="bg-transparent text-white text-center text-4xl font-body md:w-10 w-8 border-b-4 border-white ml-5" type="text" max-length="1" />
                                    <input className="bg-transparent text-white text-center text-4xl font-body md:w-10 w-8 border-b-4 border-white" type="text" max-length="1" />
                                    <input className="bg-transparent text-white text-center text-4xl font-body md:w-10 w-8 border-b-4 border-white" type="text" max-length="1" />
                                </div>
                        ...
                        <div className="flex flex-wrap md:flex-nowrap gap-8 mt-10">
                            <div className="flex flex-col gap-5 w-full">
                                <p className="text-xl text-white font-body">E-postayı değiştir</p>
                                <input type="text" name="topic-input" id="topic-input" className="outline-transparent w-full text-lg text-white py-4 px-10 bg-input rounded-full" placeholder="Yeni e-posta" />
                            ...
                            <div className="flex flex-col gap-5 w-full">
                                <p className="text-xl text-white font-body">Şifreyi değiştir</p>
                                <input type="text" name="topic-input" id="topic-input" className="outline-transparent w-full text-lg text-white py-4 px-10 bg-input rounded-full" placeholder="Geçerli parola" />
                                <input type="text" name="topic-input" id="topic-input" className="outline-transparent w-full text-lg text-white py-4 px-10 bg-input rounded-full" placeholder="Yeni şifre" />
                                <button className="md:w-fit w-full bg-green text-dark text-lg py-4 px-10 flex items-center justify-center font-bold rounded-full gap-4 hover:opacity-80">
                                    Devam etmek
                                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.79289 0.492844C8.18342 0.10232 8.81658 0.10232 9.20711 0.492844L16.2071 7.49284C16.5976 7.88337 16.5976 8.51653 16.2071 8.90706L9.20711 15.9071C8.81658 16.2976 8.18342 16.2976 7.79289 15.9071C7.40237 15.5165 7.40237 14.8834 7.79289 14.4928L13.0858 9.19995H1.5C0.947715 9.19995 0.5 8.75224 0.5 8.19995C0.5 7.64767 0.947715 7.19995 1.5 7.19995H13.0858L7.79289 1.90706C7.40237 1.51653 7.40237 0.883369 7.79289 0.492844Z" fill="#1C1B23"/>
            ...
            <div className="container container-sm pt-20 md:px-8 px-4" id="history">
                <h2 className="font-body md:text-5xl text-4xl text-white uppercase font-semibold">Sipariş geçmişi</h2>
            </div>       
