...
export default function TRBalancePage() {
    ...
    return (
        <main className="main flex flex-col flex-1">
            <div className="container container-sm md:overflow-auto overflow-hidden pt-20 md:px-8 px-4">                
                <h1 className="font-body md:text-5xl text-3xl text-white uppercase font-semibold">Denge kontör</h1>
                <div className="bg-blue rounded-3xl py-6 md:md:px-8 px-4 flex gap-10 mt-8">
                    <p className="font-display font-bold md:text-2xl text-base text-white">Bir şeyler ters gitti ve biz düzeltiyoruz. Lütfen biraz bekleyin veya başka bir ödeme seçeneği deneyin. Bu mesajı çok sık görürseniz, lütfen buradaki form aracılığıyla destek ekibimizle iletişime geçin.</p>
                ...
                <div className="flex lg:flex-row flex-col mt-10 gap-10 items-start">
                    <div className="bg-green md:rounded-3xl rounded-[30px] md:p-12 px-6 py-8 gap-4 flex flex-col w-full max-w-[440px] relative">
                        <p className="font-body text-2xl mb-3">Mevcut bakiyeniz</p>
                    ...
                    <div className="flex flex-col w-full">
                        <div className="bg-gray-secondary rounded-3xl md:p-11 p-6 py-8 flex flex-col gap-10">
                            <p className="text-3xl text-white font-bodt font-semibold uppercase">Denge kontör</p>
                            ...
                            <label className="font-body text-white items-start gap-6" htmlFor="privacy">"Şartlar ve Koşullar", "Gizlilik politikası", "Sorumlu oyun", "Garanti yok" u okudum ve kabul ettim.</label>
            ...
            <div className="container container-sm md:mt-40 mt-20" id="message">
                <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-20 gap-10">
                    <div className="flex flex-col">                        
                        <h2 className="font-body text-3xl text-white uppercase font-semibold mb-10">Canını sıkan bir şey mi var?</h2>
                        <p className="font-display text-[22px] font-bold text-white md:mb-20 mb-10">Bir rapor vermek istiyorum...</p>
                        <div className="grid sm:grid-cols-2 grid-cols-1 text-center gap-4">
                            <div className="font-display font-bold md:text-xl text-base text-white py-6 px-2 bg-gray-secondary rounded-full cursor-pointer" onClick={setActiveItem}>Uyumlu</div>
                            <div className="font-display font-bold md:text-xl text-base text-white py-6 px-2 bg-gray-secondary rounded-full cursor-pointer active_item" onClick={setActiveItem}>Teknik sorun</div>
                        </div>
                        <img src="img/sad-square.png" alt="" className="mt-12  hidden lg:block" />
                    </div>
                    <div className="flex flex-col">
                        <textarea name="message" id=" message" placeholder="Mesajınız nedir?" className="outline-transparent lg:h-full h-[400px] resize-none w-full font-display text-[22px] text-white py-6 px-10 bg-input"></textarea>
                        <button className="w-full bg-green text-dark md:text-3xl text-lg font-display md:py-10 py-7 mt-14 flex items-center justify-center font-bold rounded-full md:gap-6 gap-3 uppercase hover:opacity-80">
                            göndermek
