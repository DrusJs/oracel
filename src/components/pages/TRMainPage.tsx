                    ...
                    <div className="flex gap-10 flex-wrap">
                        <div className="flex flex-col pb-10">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="rounded-main p-10 flex flex-col bg-white mt-8 gap-8">
                                    <p className="font-semibold font-body text-2xl uppercase">dahil olmak üzere farklı sporlarla çalışıyoruz </p>
                        ...
                        <div className="flex flex-col pb-10">
                            <div className="flex items-center gap-3">
                                <p className="text-4xl font-semibold text-dark uppercase">ilk üç tahmininizi<br></br> almak için </p>
                            ...
                            <div className="flex justify-between gap-4 mt-10 pr-4">
                                <div className="flex gap-2 items-center">
                                    ...
                                    <p className="font-medium text-xl">Tüm tahmin<br></br> kategorileri</p>                               
                                </div>
                                <div className="flex gap-2 items-center">
                                    <img src="img/ic_round-token.svg" alt="Hero Img"/>    
                                    <p className="font-medium text-xl">Kripto ve fiat <br></br> destekli</p>                              
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container container-sm mx-auto">
                        <div className="flex">
                            <div className="flex flex-col">
                                <h2 className="text-8xl text-white uppercase font-head text-nowrap">Bizimle iletişime geçin</h2>
                                <p className="text-3xl text-white">tüm sorularınızı kişisel olarak cevaplayacağız - sadece bize bir e-posta gönderin</p>
                            ...
                            <form className="flex flex-col w-full max-w-2xl">
                                <input type="email" name="email-input" id="email-input" className="outline-transparent w-full text-xl text-white py-6 px-10 bg-input rounded-full mb-6" placeholder="E-postan ne?" />
                                <input type="text" name="topic-input" id="topic-input" className="outline-transparent w-full text-xl text-white py-6 px-10 bg-input rounded-full mb-6" placeholder="Konu nedir?" />
                                <textarea name="message" id=" message" placeholder="Mesajınız nedir?" className="outline-transparent h-60 resize-none w-full text-xl text-white py-6 px-10 bg-input"></textarea>
                            </form>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="flex flex-col gap-12">
                                <div className="flex gap-2 md:items-center items-start justify-between md:flex-row flex-col">
                                    <div className="bg-gray-secondary rounded-3xl font-bold px-10 py-3 sm:w-auto w-full">
                                        ...
                                        <label className="font-body font-medium text-xl text-secondary" htmlFor="score-check"><div>Her zaman dahil et <span className='font-extrabold'>Score</span></div></label>
                                    </div>
                                    <div className="bg-gray-secondary rounded-3xl font-bold px-10 py-3 sm:w-auto w-full">
                                        <input className="hidden" type="checkbox" name="" id="handicap-check" />
                                        <label className="font-body font-medium text-xl text-secondary" htmlFor="handicap-check"><div>Her zaman dahil et <span className='font-extrabold'>Handicap</span></div></label>
                                    </div>
                                    <div className="bg-gray-secondary rounded-3xl font-bold px-10 py-3 sm:w-auto w-full">
                                        <input className="hidden" type="checkbox" name="" id="total-check" />
                                        <label className="font-body font-medium text-xl text-secondary" htmlFor="total-check"><div>Her zaman dahil et <span className='font-extrabold'>Total</span></div></label>
                                    </div>
                                </div>
                                    ...
                                    <div className="card-side gap-10 flex-col">
                                        ...
                                        <div className="flex xl:flex-nowrap flex-wrap gap-10">
                                            ...
                                            <div className="flex md:flex-col flex-row items-center gap-6">
                                                ...
                                                <button className="bg-green rounded-full font-bold md:text-2xl text-xl md:px-10 text-nowrap md:py-6 px-6 py-4 hover:opacity-80" onClick={toggleCard}>Sonuçları alın</button>
                                            </div>
                                        </div>
                                    </div>
