...
export default function DTBalancePage() {
    ...
    return (
        <main className="main flex flex-col flex-1">
            <div className="container container-sm md:overflow-auto overflow-hidden pt-20 md:px-8 px-4">                
                <h1 className="font-body md:text-5xl text-3xl text-white uppercase font-semibold">Guthaben aufladen</h1>
                <div className="bg-blue rounded-3xl py-6 md:md:px-8 px-4 flex gap-10 mt-8">
                    <p className="font-display font-bold md:text-2xl text-base text-white">Etwas ist schief gelaufen, und wir reparieren es. Bitte warten Sie ein wenig oder versuchen Sie es mit einer anderen Zahlungsoption. Wenn Sie diese Nachricht zu oft sehen, wenden Sie sich bitte über das hierin enthaltene Formular an unser Support-Team</p>
                ...
                <div className="flex lg:flex-row flex-col mt-10 gap-10 items-start">
                    <div className="bg-green md:rounded-3xl rounded-[30px] md:p-12 px-6 py-8 gap-4 flex flex-col w-full max-w-[440px] relative">
                        <p className="font-body text-2xl mb-3 text-dark">Ihr aktueller Kontostand</p>
                        <p className="font-body md:text-6xl text-5xl font-semibold text-dark">150.20 EUR</p>
                    ...
                    <div className="flex flex-col w-full">
                        <div className="bg-gray-secondary rounded-3xl md:p-11 p-6 py-8 flex flex-col gap-10">
                            <p className="text-3xl text-white font-bodt font-semibold uppercase">Guthaben aufladen</p>
            ...
            <div className="container container-sm md:mt-40 mt-20" id="message">
                <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-20 gap-10">
                    <div className="flex flex-col">                        
                        <h2 className="font-body text-3xl text-white uppercase font-semibold mb-10">Stört dich etwas?</h2>
                        <p className="font-display text-[22px] font-bold text-white md:mb-20 mb-10">Ich möchte einen Bericht...</p>
                        <div className="grid sm:grid-cols-2 grid-cols-1 text-center gap-4">
                            <div className="font-display font-bold md:text-xl text-base text-white py-6 px-2 bg-gray-secondary rounded-full cursor-pointer" onClick={setActiveItem}>Konform</div>
                            <div className="font-display font-bold md:text-xl text-base text-white py-6 px-2 bg-gray-secondary rounded-full cursor-pointer active_item" onClick={setActiveItem}>Technisches Problem</div>
                        </div>
                        <img src="img/sad-square.png" alt="" className="mt-12  hidden lg:block" />
                    </div>
                    <div className="flex flex-col">
                        <textarea name="message" id=" message" placeholder="Was ist deine Botschaft?" className="outline-transparent lg:h-full h-[400px] resize-none w-full font-display text-[22px] text-white py-6 px-10 bg-input"></textarea>
