                    ...
                    <div className="flex xl:flex-nowrap flex-wrap items-start gap-10">
                        <aside className="flex flex-col md:p-10 p-8 xl:gap-20 gap-6 bg-green rounded-3xl xl:max-w-md w-full" onClick={toggleDropdown}>
                            ...
                            <div className="dropdown-item flex flex-col gap-2">
                                ...
                                <p className="font-body text-lg mb-4">- eine numerische Summe von Indikatoren / eine Wette auf ein Ereignisergebnis, die auf einer numerischen Summe von Indikatoren basiert (z. B. die Gesamtzahl der Tore in einem Fußballspiel).</p>
                                
                                <p className="font-body text-xl font-semibold uppercase">Handicap</p>
                                <p className="font-body text-lg mb-4">- die Überlegenheit oder Unterlegenheit einer Mannschaft oder eines Spielers, ausgedrückt in Toren, Punkten, Sätzen, Sekunden usw</p>
                                
                                <p className="font-body text-xl font-semibold uppercase">Score</p>
                                <p className="font-body text-lg mb-10">- Gesamtbetrag der Gewinner-Matchpunkte und Verlierer-Matchpunkte
                                </p>

                                <p className="font-body text-xl font-semibold uppercase max-w-">der prognostizierte Preis wird steigen</p>
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="font-body text-lg">in weniger als 6 Monaten vor dem Spiel</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="font-body text-lg">in weniger als 1 Monaten vor dem Spiel</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.29289 0.292893C4.48043 0.105357 4.73478 0 5 0H13C13.2652 0 13.5196 0.105357 13.7071 0.292893C13.8946 0.48043 14 0.734784 14 1C14 1.26522 13.8946 1.51957 13.7071 1.70711C13.5196 1.89464 13.2652 2 13 2H5C4.73478 2 4.48043 1.89464 4.29289 1.70711C4.10536 1.51957 4 1.26522 4 1C4 0.734784 4.10536 0.48043 4.29289 0.292893Z" fill="#1C1B23"/>
                                    ...
                                    <p className="font-body text-lg">in weniger als 1 Woche vor dem Spiel</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.29289 0.292893C4.48043 0.105357 4.73478 0 5 0H13C13.2652 0 13.5196 0.105357 13.7071 0.292893C13.8946 0.48043 14 0.734784 14 1C14 1.26522 13.8946 1.51957 13.7071 1.70711C13.5196 1.89464 13.2652 2 13 2H5C4.73478 2 4.48043 1.89464 4.29289 1.70711C4.10536 1.51957 4 1.26522 4 1C4 0.734784 4.10536 0.48043 4.29289 0.292893Z" fill="#1C1B23"/>
                                    ...
                                    <p className="font-body text-lg">wird der höchste sein, wenn das Spiel morgen ist</p>
                                </div>                                
