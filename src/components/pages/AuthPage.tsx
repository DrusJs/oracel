                ...
                <div className="flex gap-36">
                    <div className="flex flex-col w-full">
                        ...
                        <form className="flex flex-col w-full lg:max-w-2xl mt-12">
                            ...
                            <label className="mt-12 font-body text-white flex md:gap-6 gap-4" htmlFor="privacy">I have read and accepted «Terms and Conditions», «Responsible gaming», «No warranties»</label>
                            <input className="hidden" type="checkbox" name="" id="age-check" />
                            <label className="mt-3 font-body text-white flex md:gap-6 gap-4" htmlFor="age-check">I am over 18 years old</label>
