                        ...
                        <div className="flex flex-col pb-10">
                            ...
                            <div className="flex justify-between md:gap-4 gap-2 mt-10 pr-4">
                                <div className="flex gap-2 items-center">
                                    ...
                                    <p className="font-medium md:text-xl text-base">All categories of<br></br> forecasts</p>                               
                                </div>
                                <div className="flex gap-2 items-center">
                                    <img src="img/ic_round-token.svg" alt="Hero Img"/>    
                                    <p className="font-medium md:text-xl text-base">Crypto and fiat <br></br> supported</p>                              
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container container-sm mx-auto md:px-8 px-4">
                        <div className="flex xl:flex-row flex-col relative xl:gap-0 gap-10">
                            <div className="flex flex-col xl:gap-2 gap-10">
                                <h2 className="md:text-8xl text-6xl text-white uppercase font-head xl:text-nowrap">Contact us</h2>
                                <p className="font-display md:text-3xl text-[22px] text-secondary xl:pr-0 md:pr-40 pr-24">We will answer all your questions personally - just send us an e-mail</p>
                            ...
                            <form className="flex flex-col w-full max-w-2xl">
                                <input type="email" name="email-input" id="email-input" className="backdrop-blur outline-transparent w-full text-xl text-white py-6 md:px-10 px-6 bg-input rounded-full mb-6" placeholder="What’s your e-mail?" />
                                <input type="text" name="topic-input" id="topic-input" className="outline-transparent w-full text-xl text-white py-6 md:px-10 px-6 bg-input rounded-full mb-6" placeholder="What’s the topic?" />
                                <textarea name="message" id=" message" placeholder="What’s your message?" className="outline-transparent h-60 resize-none w-full text-xl text-white py-6 md:px-10 px-6 bg-input mb-10"></textarea>
                    ...
                    <div className="flex xl:flex-nowrap flex-wrap items-start gap-10">
                        <aside className="flex flex-col md:p-10 p-8 xl:gap-20 gap-6 bg-green rounded-3xl xl:max-w-md w-full" onClick={toggleDropdown}>
                            ...
                            <div className="dropdown-item flex flex-col gap-2">
                                ...
                                <p className="font-body text-lg mb-4">– team or player, who wins the game</p>
                                
                                <p className="font-body text-xl font-semibold uppercase">total</p>
                                <p className="font-body text-lg mb-4">– a numerical total of indicators / a bet on an event outcome which is based on a numerical total of indicators (for example, the total number of goals in a football match).</p>
                                ...
                                <p className="font-body text-lg mb-10">– total amount of winner match points and looser match points</p>

                                <p className="font-body text-xl font-semibold uppercase max-w-">the forecast Price will increase</p>
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="font-body text-lg">in less than 6 months before the game</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="font-body text-lg">in less than 1 months before the game</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.29289 0.292893C4.48043 0.105357 4.73478 0 5 0H13C13.2652 0 13.5196 0.105357 13.7071 0.292893C13.8946 0.48043 14 0.734784 14 1C14 1.26522 13.8946 1.51957 13.7071 1.70711C13.5196 1.89464 13.2652 2 13 2H5C4.73478 2 4.48043 1.89464 4.29289 1.70711C4.10536 1.51957 4 1.26522 4 1C4 0.734784 4.10536 0.48043 4.29289 0.292893Z" fill="#1C1B23"/>
                                    ...
                                    <p className="font-body text-lg">in less than 1 week before the game</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.29289 0.292893C4.48043 0.105357 4.73478 0 5 0H13C13.2652 0 13.5196 0.105357 13.7071 0.292893C13.8946 0.48043 14 0.734784 14 1C14 1.26522 13.8946 1.51957 13.7071 1.70711C13.5196 1.89464 13.2652 2 13 2H5C4.73478 2 4.48043 1.89464 4.29289 1.70711C4.10536 1.51957 4 1.26522 4 1C4 0.734784 4.10536 0.48043 4.29289 0.292893Z" fill="#1C1B23"/>
                                    ...
                                    <p className="font-body text-lg">will be the highest if the game is tomorrow</p>
                                </div>                                
                        ...
                        <div className="flex flex-col w-full">
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col-reverse xl:flex-col gap-12">
                                ...
                                <div className="flex gap-4 ml-auto">
                                    <button className="w-10 h-10 rounded-[10px] bg-gray-secondary flex items-center justify-center font-body font-semibold text-lg">
                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.47206 11.1381C6.21171 11.3985 5.7896 11.3985 5.52925 11.1381L0.862579 6.47145C0.60223 6.2111 0.60223 5.78899 0.862579 5.52864L5.52925 0.861969C5.7896 0.60162 6.21171 0.60162 6.47206 0.861969C6.7324 1.12232 6.7324 1.54443 6.47206 1.80478L2.94346 5.33337L10.6673 5.33337C11.0355 5.33337 11.334 5.63185 11.334 6.00004C11.334 6.36823 11.0355 6.66671 10.6673 6.66671L2.94346 6.66671L6.47206 10.1953C6.7324 10.4557 6.7324 10.8778 6.47206 11.1381Z" fill="#848484"/>
                                        </svg>
                                    </button>
                                    <button className="w-10 h-10 rounded-[10px] bg-white flex items-center justify-center font-body font-semibold text-base">1</button>
                                    <button className="w-10 h-10 rounded-[10px] bg-gray-secondary text-white flex items-center justify-center font-body font-semibold text-base">2</button>
                                    <button className="w-10 h-10 rounded-[10px] bg-gray-secondary text-white flex items-center justify-center font-body font-semibold text-base">3</button>
                                    <button className="w-10 h-10 rounded-[10px] bg-gray-secondary flex items-center justify-center font-body font-semibold text-lg">
                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.52794 11.1381C5.78829 11.3985 6.2104 11.3985 6.47075 11.1381L11.1374 6.47145C11.3978 6.2111 11.3978 5.78899 11.1374 5.52864L6.47075 0.861969C6.2104 0.60162 5.78829 0.60162 5.52794 0.861969C5.2676 1.12232 5.2676 1.54443 5.52794 1.80478L9.05654 5.33337L1.33268 5.33337C0.964492 5.33337 0.666016 5.63185 0.666016 6.00004C0.666016 6.36823 0.964492 6.66671 1.33268 6.66671L9.05654 6.66671L5.52794 10.1953C5.2676 10.4557 5.2676 10.8778 5.52794 11.1381Z" fill="#848484"/>
                                        </svg>
                                    </button>
                                </div>
                            </div>
